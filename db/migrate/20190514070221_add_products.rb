...
:is_spicy => false, :is_veg   => false, :is_best_offer => false, :path_to_image => '/images/1.jpg'	
  	...
  	Product.create :title => 'Paperoni', :description => 'Its Paperoni pizza Big size', :price => 10, :size  => 60, :is_spicy => true, :is_veg   => false, :is_best_offer => false, :path_to_image => '/images/2.jpg'	
  end
end
